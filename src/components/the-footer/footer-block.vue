      ...
      <div class="container flex footer-top">
        <div class="footer-block">
          ...
          <p class="paragraph white">
            Class aptent taciti sociosqu ad litora torquent per conubia nostra, persinioa inceptos
        ...
        <div class="container flex">
          ...
          <div class="footer-bot flex">
            <div class="footer-left">
              ...
              e:
              <a href="mailto:info@bestpsdfreebies.com" class="inherit">info@bestpsdfreebies.com</a>
            </div>
            <div class="footer-right">
              <p>
                Copyright 2012. Powered by
                <a href="#" class="footer-bot-link">Wordpress</a>
              </p>
              <p>
                <a href="#" class="footer-bot-link">Portfolio</a> Theme by
                <a href="#" class="footer-bot-link">Best PSD Freebies</a>
              </p>
            </div>
          </div>
        </div>
...
<script>
import FlickWidget from './flick-widget/flick-widget.vue';
import Logo from '../the-header/the-header-logo/the-header-logo.vue';
import RecentPost from './recent-post/recent-post.vue';
import TwitterWidget from '../aside-block/twitter-widget/twitter-widget.vue';
