    ...
    <main class="main">
      <div class="container flex">
        <main class="content">
          ...
          <button class="the-btn btn-orange">Button Text</button>
          <button class="the-btn btn-pink">Button Text</button>
          <button class="the-btn btn-red">Button Text</button>
          <button class="the-btn btn-lightblue">Button Text</button>
          <div class="block-alerts">
            <div class="block-alert-item alert-green">Alert Text</div>
            <div class="block-alert-item alert-red">Alert Text</div>
