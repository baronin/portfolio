<template>
  <div>
    <nav class="nav">
      <ul class="portfolio-nav flex">
        <li class="portfolio-nav-item">
          <label class="portfolio-nav-link"
            ><input
              class="input-hover"
              type="radio"
    ...
    <div class="flex content-portfolio">
      ...
      <div
        class="block-my-works"
        v-for="(portfolio, index) in filterTag"
        :key="index"
      >
        <div class="block-image">
          <img :src="portfolio.img" class="portfolio-img" />
          <!--<li v-for="portfolio in filterTag"> {{portfolio.title}}</li>-->
        ...
        <div class="block-title">
          ...
          <div class="tag flex">
            ...
            <a
              href="#"
              class="tag-link"
              v-for="(tagUnit, tagIndex) in portfolio.tag"
              :key="tagIndex"
            >
              {{ tagUnit }}
            </a>
  ...
  computed: {
    filterTag() {
      ...
      return this.portfolio.filter(
        (portfolioUnit) =>
          portfolioUnit.tag.filter(
            (portfolioTag) => tags.indexOf(portfolioTag) !== -1
          ).length > 0
      );
    },
  },
